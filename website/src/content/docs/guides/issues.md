...
for line-anchored comments on a diff, see [Code Review](/guides/code-review/).
...
[Importing from GitHub](/guides/importing/#current-limitations).

## Reference

- [Issues API](/reference/endpoints/)
